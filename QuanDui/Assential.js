...
const Assential=({navigation})=>{
  const F= [
            require('../Image/quandui4.png'),
            require('../Image/quandui5.png'),
            require('../Image/quandui1.png'),
            require('../Image/quandui2.png'),
                ]
     return (
            ...
            <ScrollView >
             ...
             />
              ...
              <View style={Styles.foot}>
                 <Text style={{fontSize:20,marginTop:10,marginLeft:10}}>Quần đùi Assential White</Text>
