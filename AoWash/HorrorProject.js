...
const HorrorProject=({navigation})=>{
  const F= [
            require('../Image/aowash4.png'),
            require('../Image/aowash5.png'),
            require('../Image/aowash1.png'),
            require('../Image/aowash2.png'),
                ]
     return (
            ...
            <ScrollView >
             ...
             />
              ...
              <View style={Styles.foot}>
                 <Text style={{fontSize:20,marginTop:10,marginLeft:10}}>Áo Wash HorrorProject</Text>
                 <Text style={{fontSize:20,marginTop:10,marginLeft:10,color:'red'}}>₫290.000</Text>
              ...
              <View style={Styles.spkhac}>
                ...
                <ScrollView horizontal={true}>
                  ...
                  <View style={Styles.iconsp}>
                    <Image source={require('../Image/aowash4.png')} style={Styles.imagespkhac}/>
                    <Text style={Styles.Textspkhac}>Áo Wash SupperDogs</Text>
